...
public interface IOSF_Warehouse_Mapper {
		...
		//검색된 게시물 페이지
	    public List<WareHouse_DTO> IOSF_search_whpaged(String m_search, Integer startIndex, Integer pageSize, String wh_type); 
		
		//검색 게시물 총 갯수
	    public int IOSF_searchTotal(String m_search);
