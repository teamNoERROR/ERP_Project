...
public interface goods_service {
	JSONArray gd_class(String goods_type);
	JSONArray sc_class(String goods_type, String pd_class1);
//	List<String> pd_class_list(String pd_class1);	//완제품 대분류 리스트 
	
	int gd_insert(products_DTO pdto);	//제품 등록
	List<products_DTO> gd_all_list(String type);	//제품 리스트(완제품+부자재)
